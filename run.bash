...
CUDA_LAUNCH_BLOCKING=1 python main.py -m ${model_name} -bs ${batch_size} -lr ${learning_rate} -epoch ${epoch} -use-cuda -device-tab ${device_tab} -num-workers 10 -log -em-dim ${embedding_dim}
